...
import com.example.spring.di.service.EmailService;
import com.example.spring.di.service.MessageService;

@Configuration
@ComponentScan(value="com.example.spring.di.consumer")
public class MyApplicationTest {
	...
	public void test() {
		...
		Assert.assertTrue(app.processMessage("Hi dude", "dude@abc.com"));
	}
}
